...
def compute_reward(data: DataProto, global_steps, reward_fn: AbstractRewardManager) -> tuple[Any, Any, Any, Any, Any]:
    """
...
def compute_reward_async(data: DataProto, global_steps, config=None, tokenizer=None, reward_fn=None):
    """
